...
describe("<ProfileCard/>", () => {
  ...
  test("should be to defined ProfileCard", () => {
    const { getByTestId, getByDisplayValue,  debug } = ComponentRender(<ProfileCard profile={mockProfile} edit={mockProfile} isLoading={false} error={undefined} readonly={false} />);
